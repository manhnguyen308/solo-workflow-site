...
If those rules live only in the contract PDF, move the operational signals into the active project record. For the billing process, use [Invoice and payment workflow setup](/workflows/invoice-and-payment-workflow-setup-for-freelancers-and-consultants/).
