...
Use the review window, reminder terms, and escalation trigger already agreed with the client. If none exists, send a message that names the decision needed and proposes a response date based on the blocked work. Do not introduce automatic approval or another contractual consequence unless it was agreed in advance.

A visible response or escalation trigger keeps the review state from remaining open without an owner.
...
At that point, name it in the system as blocked review or pending client decision.
