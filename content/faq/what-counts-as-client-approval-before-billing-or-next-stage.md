...
page_role = "support"
hub_priority = 5
related = ["/workflows/milestone-delivery-workflow-for-solo-service-businesses/", "/glossary/approval-owner/", "/templates/approval-and-feedback-routing-worksheet-for-multi-stakeholder-review/", "/faq/what-to-do-when-a-client-goes-silent-during-review/", "/workflows/invoice-and-payment-workflow-setup-for-freelancers-and-consultants/", "/workflows/client-offboarding-workflow-for-freelancers-and-solo-service-businesses/"]
featured = false
+++

A positive client reaction and a formal approval are not the same thing.

Use this answer when a client has responded but you cannot tell whether the response closed the review stage or only acknowledged the work. The agreement and documented review rules determine what approval requires.

## Define the approval path first when

- The review stage does not name who can approve.
...
Unless your agreement or review rules explicitly say otherwise, do not treat these responses as approval:
...
When an invoice is contractually tied to approval, verify that:
...
- the invoice trigger in the agreement is met.

If the billing terms use a different trigger, follow those terms. Do not replace the agreed trigger with an implied approval rule during the project.
...
If the agreement permits work to continue without explicit approval, document the condition that allows it and keep any unresolved review item visible.
