...
feature_image_alt = "Editorial FAQ illustration showing a completed project stage waiting for formal engagement closure while the client has not confirmed closeout."
draft = false
...
- If you are unsure whether a client response at delivery actually counted as approval, use [FAQ: What Counts as Client Approval Before Billing or the Next Stage Starts?](/faq/what-counts-as-client-approval-before-billing-or-next-stage/).
- If final approval has not yet been given and billing has not closed, this page does not apply yet — go to the offboarding workflow and complete the approval and billing stages first.
...
- If you have not yet formally closed the final milestone and billing stage, go to [Client Offboarding Workflow for Freelancers and Solo Service Businesses](/workflows/client-offboarding-workflow-for-freelancers-and-solo-service-businesses/).
- If the client is not responding at all — not just to the closeout but throughout the final stage — go to [FAQ: What Should I Do When a Client Goes Silent During Review?](/faq/what-to-do-when-a-client-goes-silent-during-review/).
- If closeout has been delayed long enough that you need to formally name it as a blocked state, use [Escalation and Pause-State Worksheet for Solo Operators](/templates/escalation-and-pause-state-worksheet-for-solo-operators/).
- If the project is closed and you are ready to request a testimonial or initiate offboarding admin, use [Client Offboarding and Testimonial Request Template](/templates/client-offboarding--testimonial-request-template/).
