...
summary = "Name the missing input, its owner, and its effect, then follow up without leaving work in vague waiting."
feature_image = "/images/features/faq/client-input-delay-faq.webp"
feature_image_alt = 'Cover titled "Client Input Delay FAQ" with a large question mark.'
draft = false
...
For the operating rule, use [Milestone delivery workflow for solo service businesses](/workflows/milestone-delivery-workflow-for-solo-service-businesses/).
