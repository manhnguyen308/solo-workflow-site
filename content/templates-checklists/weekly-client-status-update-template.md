...
related = ["/workflows/client-status-update-workflow-for-freelancers-and-consultants/", "/templates/weekly-client-operations-checklist-solo-business/", "/comparisons/email-vs-client-portal-for-deliverables-and-approvals/", "/glossary/approval-owner/"]
featured = false
+++
...
## Gaps the message should expose

- vague updates that reassure but do not clarify anything,
- missing progress or next-action information that would otherwise require a follow-up,
- approvals getting buried in long email threads,
- progress notes living only in your head.

## Send it on the agreed cadence

- on the weekly cadence agreed for the project,
...
## Keep each update easy to act on
...
## Handle these message variations
