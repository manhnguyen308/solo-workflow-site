...
- delivery is recorded as complete under the agreement,
...
> "Thanks again for working together. If you found this project valuable, would you be open to a short testimonial on your experience and results? A few sentences on the problem, process, and outcome would be helpful."

### 5) Referral and future-work request
...
Do not infer satisfaction from silence or technical completion. Ask only when a request is appropriate to the actual relationship and the claims can remain accurate.

## Closeout gaps to avoid
...
- Archiving the project without recording the delivery, billing, and signoff state.
- Offering the next project too aggressively before confirming satisfaction with the current one.

## Decide these closeout variations explicitly
...
- Billing issues: [Invoice and payment workflow setup](/workflows/invoice-and-payment-workflow-setup-for-freelancers-and-consultants/)
