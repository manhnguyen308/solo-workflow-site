...
description = "A practical diagnostic checklist that helps solo operators name the category of a client workflow problem — sequence, approval, billing, or stack — before opening workflow, comparison, or template pages."
summary = "Use this checklist to identify what kind of workflow problem you actually have before opening any workflow, blueprint, or template page."
feature_image = "/images/features/templates/workflow-diagnostic-checklist.webp"
feature_image_alt = "Illustrated diagnostic checklist with four problem-category rows — sequence, approval, billing, and stack — for sorting a client workflow problem before browsing solutions."
draft = false
...
If you already know the category of your problem, skip this checklist and go directly to the [Problem-to-Page Guide](/problem-to-page-guide/) to find the exact page.
...
In those cases, return to [Freelance Client Workflow System: Inquiry to Final Payment](/workflows/freelance-client-workflow-system-inquiry-to-final-payment/) before using this checklist. The diagnostic is most useful when the lifecycle is mostly understood and one part is consistently failing.
...
**Route:** Return to [Freelance Client Workflow System: Inquiry to Final Payment](/workflows/freelance-client-workflow-system-inquiry-to-final-payment/) and identify the stage where the sequence first breaks. Do not open comparison or template pages before the stage sequence is clear.
...
**Route:** Start with [FAQ: What Counts as Client Approval?](/faq/what-counts-as-client-approval-before-billing-or-next-stage/), then continue to [Milestone Delivery Workflow](/workflows/milestone-delivery-workflow-for-solo-service-businesses/) to tighten the stage-close and handoff rule.
...
**Route:** Start with [Invoice and Payment Workflow Setup](/workflows/invoice-and-payment-workflow-setup-for-freelancers-and-consultants/). If the specific question is where billing status should live in the tool stack, add [Best Home for Billing Status: Invoicing Tool vs System of Record](/comparisons/best-home-for-billing-status-invoicing-tool-vs-system-of-record/).
...
**Route:** Start with [CRM vs Project Management Tool for Client Workflows](/comparisons/crm-vs-project-management-tool-for-client-workflows/) to decide where client truth should live. Then continue to [Software Stack Blueprint: Solo Freelancer (Lean Budget)](/guides/software-stack-blueprint-solo-freelancer-lean-budget/) to implement the stack model.
...
**Route:** Go to the [Workflow Starter Pack](/templates/workflow-starter-pack/) to find a bundle of assets organized by lifecycle stage, or use the [Templates and Checklists hub](/templates-checklists/) to find the exact trigger-moment asset you need.
...
**Route:** Go to the [Problem-to-Page Guide](/problem-to-page-guide/) and scan for your exact symptom. If the blocker is a term, go to the [Glossary](/glossary/). If the blocker is a narrow operational question, go to the [FAQ hub](/faq/).

---

## What your answers mean

| Most signals in... | Problem category | First page to open |
| --- | --- | --- |
| Category 1 | Workflow sequence | [Freelance Client Workflow System anchor](/workflows/freelance-client-workflow-system-inquiry-to-final-payment/) |
| Category 2 | Approval or delivery | [FAQ: What Counts as Client Approval?](/faq/what-counts-as-client-approval-before-billing-or-next-stage/) |
| Category 3 | Billing or payment | [Invoice and Payment Workflow Setup](/workflows/invoice-and-payment-workflow-setup-for-freelancers-and-consultants/) |
| Category 4 | Tool or system of record | [CRM vs Project Management for Client Workflows](/comparisons/crm-vs-project-management-tool-for-client-workflows/) |
| Category 5 | Execution consistency | [Workflow Starter Pack](/templates/workflow-starter-pack/) |
| Category 6 | Narrow blocker | [Problem-to-Page Guide](/problem-to-page-guide/) |
